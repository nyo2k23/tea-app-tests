package com.thateatests.util;

public class Constants {
    public static String LOGIN_OR_REGISTER_PROMPT = "Please Login or register";
    public static String USERNAME_LENGTH_ERROR_MSG = "Should be at least 2 characters long";
